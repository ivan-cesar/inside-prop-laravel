                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="table-responsive  mt-1">
                                  <form method="post" action="{{route('justifications.update')}}" enctype="multipart/form-data">
                                      @csrf
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              aria-hidden="true">
                                                <option selected>{{$justification->motif->libelle}}</option>
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('date_depart') is-invalid @enderror" type="text" name="date_depart" value="{{date('d/m/Y',strtotime($justification->date_depart))}}">
                                              <input type="text" name="id" value="{{$justification->id}}" hidden>
                                              <!-- Le message d'erreur -->
                                                    		@error('date_depart')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
                                                    		@enderror
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('date_depart') is-invalid @enderror" type="text" name="date_retour" value="{{date('d/m/Y',strtotime($justification->date_retour))}}">
                                               <!-- Le message d'erreur -->
                                                    		@error('date_retour')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
                                                    		@enderror
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <textarea name="description" class="poppins-normal-black-16px @error('description') is-invalid @enderror" id='tinyMceExample'>
                                              {!!Html_entity_decode($justification->description)!!}
                                          </textarea>
                                           <!-- Le message d'erreur -->
                                                    		@error('description')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
