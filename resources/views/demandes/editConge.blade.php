                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="table-responsive  mt-1">
                                  <form method="post" action="{{route('demandes.modifier')}}" enctype="multipart/form-data">
                                      @csrf
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              aria-hidden="true">
                                                <option selected>{{($demande->motif->libelle)}}</option>
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('date_depart') is-invalid @enderror" type="text" name="date_depart" value="{{date('d/m/Y',strtotime($demande->date_depart))}}">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('date_retour') is-invalid @enderror" type="text" name="date_retour" value="{{date('d/m/Y',strtotime($demande->date_retour))}}">
                                              <!-- Le message d'erreur -->
                                                    		@error('date_retour')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
                                                    		@enderror
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <textarea name="message" class="poppins-normal-black-16px @error('message') is-invalid @enderror" id='tinyMceExample'>
