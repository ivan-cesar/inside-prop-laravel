                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="total-candidates cerapro-medium-cioccolato-20px">Historique de mes Notes de frais</h4>
                                  </div>
                                  <!--<div class="frame-376">
                                    <span class="number-3 cerapro-medium-mine-shaft-16px">{{$toutesNotedefrais ?? "-"}}</span>
                                    </div>-->
                                  <div>
                                    <a class="btn btn-primary btn-lg text-white mb-0 me-0" target="_blank" href="{{route('notedefrais.createUserpdf')}}"><i class="mdi mdi-export"></i>Exporter</a>
                                  </div>
                                </div>
                                  ...
                                  <table class="table select-table" id="table_dmd">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><h6>{{ucfirst($achat->projet)}}</h6></td>
                                        <td><h6>{{number_format($achat->montant,'0','','.')}} Fcfa</h6></td>
                                        <td>
                                    ...
                                    <tbody>
                                      ...
                                      @endif
                                       ...
                                       @if($achat->statut == 0)
									    ...
									    <div class="iv_row">
									        <div class="iv_edit">
									           <a style="font-size: 2rem; color:#ff6e00;" class="dropdown-item" href="{{route('notedefrais.edit',$achat->id)}}">
									               <i class="menu-icon mdi mdi-pencil"></i>
									           </a>
									        </div>
									        <div class="iv_delete">
									           <a style="font-size: 2rem; color:#ff6e00;" class="dropdown-item" href="{{route('notedefrais.delete',$achat->id)}}" onclick="return confirm('Voulez-vous Supprimer cette demande d'absence ?')">
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="table-responsive  mt-1">
                                  <form method="post" action="{{route('notedefrais.store')}}" enctype="multipart/form-data">
                                      @csrf
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              @error('motif_id') is-invalid @enderror" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                <option selected>Sélectionnez le type d'action</option>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('projet') is-invalid @enderror" type="text" name="projet">
                                              		<!-- Le message d'erreur -->
                                                    		@error('projet')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
                                                    		@enderror
