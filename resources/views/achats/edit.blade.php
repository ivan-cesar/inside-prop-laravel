                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="table-responsive  mt-1">
                                  <form method="post" action="{{route('achats.update')}}" enctype="multipart/form-data">
                                      @csrf
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              aria-hidden="true" required>
                                                <option selected>{{$achat->motif->libelle}}</option>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('intitule_projet') is-invalid @enderror" type="text" name="intitule_projet" value="{{$achat->intitule_projet}}">
                                              <!-- Le message d'erreur -->
                                              <input text="id" name="id" value="{{$achat->id}}" hidden>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input class="poppins-normal-black-16px form-control date @error('montant') is-invalid @enderror" type="text" name="montant" value="{{$achat->montant}}">
                                              <!-- Le message d'erreur -->
                                                    		@error('montant')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
                                                    		@enderror
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <textarea name="description" class="poppins-normal-black-16px @error('description') is-invalid @enderror" id='tinyMceExample'>
                                              {!!Html_entity_decode($achat->description)!!}
                                          </textarea>
                                          <!-- Le message d'erreur -->
                                                    		@error('description')
                                                    		<div class="invalid-feedback">{{ $message }}</div>
